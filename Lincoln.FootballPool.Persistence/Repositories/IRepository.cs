...
namespace Lincoln.FootballPool.Persistence.Repositories
{
        ...
        where TEntityId : struct
    {
        ...
        /// <exception cref="Lincoln.FootballPool.Persistence.PersistenceException">An error occurred retrieving the entity from the persistence store.</exception>
        ...
        /// <exception cref="Lincoln.FootballPool.Persistence.PersistenceException">An error occurred retrieving entities from the persistence store.</exception>
        ...
        /// <exception cref="Lincoln.FootballPool.Persistence.PersistenceException">An error occurred retrieving a paginated list of entities from the persistence store.</exception>
        ...
        /// <exception cref="Lincoln.FootballPool.Persistence.PersistenceException">An error occurred saving the entity to the persistence store.</exception>
